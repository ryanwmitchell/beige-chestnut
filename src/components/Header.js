                    ...
                    <div className="nav__logo">
                        <Link href={withPrefix('/')}>
                            {(white_header || (_.get(page, 'frontmatter.layout', null) === 'product')) ? (
                                <Picture {...this.props} image={_.get(site, 'data.config.logo_light', null)} cssClass={'nav__logo-image'} alt={'Planty logo'} />
                            ) : 
                                <Picture {...this.props} image={_.get(site, 'data.config.logo_dark', null)} cssClass={'nav__logo-image'} alt={'Planty logo'} />
                            }
                        </Link>
                    </div>
